...
const MAP_ROWS = [
  ...
  { name: "京大キャンパス・吉田山", price: "地図の販売のみ / 150円/枚 / 京都市左京区 / 1:4000 / 随時更新", note: "外部の方は販売のみです。(オリエンテーリング大会用として販売はしていません。)" },
  { name: "グリム冒険の森", price: "販売中 / 300円/枚 / 滋賀県蒲生郡日野町 / 1:10000", note: "2015西プロ・2017越智ほか修正。" },
  { name: "霊山", price: "販売中 / 300円/枚 / 三重県伊賀市 / 1:15000・1:10000 / 最終修正 2017年", note: "西プロ＋京大修正。" },
  { name: "東山", price: "販売中 / 300円/枚 / 京都府京都市 / 1:10000 / 最終修正 2015年", note: "京大修正。版権は京都府オリエンテーリング協会。" },
  { name: "大柳生", price: "販売中 / 200円/枚 / 奈良県奈良市 / 1:15000・1:10000 / 最終修正 2020年", note: "最終使用: 2024/6/1 朱雀OK壮行会兼名阪戦。2025年以降は販売停止中。" },
  { name: "蛇喰池", price: "販売中 / 300円/枚 / 三重県伊賀市 / 1:10000 / 最終修正 ????年", noteHtml: "霊山隣接テレイン。併用で使用したい場合は<a href=\"#map-shin-reizan\">シン・霊山</a>を参照。" },
  { id: "map-shin-reizan", name: "シン・霊山", price: "販売中 / 400円/枚 / 三重県伊賀市 / 1:15000・1:10000 / 最終修正 2022年", note: "" },
  { name: "伊庭", price: "販売中？ / 300円/枚 / 滋賀県東近江市 / 1:4000 / 最終修正 2023年", note: "第28回京大京女立命館大会で制作。" },
  { name: "上桐生・平野", price: "販売停止 / 300円/枚 / 滋賀県大津市 / 1:10000 / 最終修正 2023年", note: "第27回京大京女立命大会で使用。テレインの環境悪化のため販売停止。" },
  { name: "決戦 天王山", price: "非販売地図 / 200円/枚 / 京都府大山崎町・長岡京市 / 1:10000 / 最終修正 2003年", noteHtml: "京都府協会の<a href=\"http://www.orienteering.com/~kyotofu/index.php?category=pc\">HP</a>から無料ダウンロード可能。猟期なし。" },
  { name: "近江塩津", price: "販売中 / 300円/枚 / 滋賀県長浜市 / 1:10000 / 最終修正 2023年", note: "2バージョンあり。" },
  { name: "甲賀油日", price: "販売中 / 300円/枚 / 滋賀県甲賀市 / 1:10000 / 最終修正 2024年", note: "利用は年に一度まで（毎冬が望ましい）。" }
];
...
window.KUOLC_PAGES = {
  ...
  orienteering: {
    ...
    subnav: SHINKAN_NAV,
    sections: [{ blocks: [
      { type: "lead", text: "オリエンテーリングは、北欧発祥の屋外スポーツです。ポストと呼ばれるチェックポイントのような地点を順番に回ります。このポイントの位置は決まっていますが、ポイント間をどのように進むかは自分で決めます。" },
      { type: "media", title: "コントロールを探して進む", src: IMG.flag, alt: "森の中のコントロールフラッグ", caption: "白とオレンジのフラッグがコントロールの目印です。", text: [
        "地図に描かれた丸の位置へ行くと、コントロールと呼ばれる目印があります。そこを順番どおりに回り、ゴールまでのタイムを競います。",
      ...
      { type: "media", title: "時には学校の中を走ることも、、！", src: IMG.schoolEvent, alt: "学校内で行われるオリエンテーリング", caption: "スプリントは、公園だけでなく学校など普段走れないところがコースになることも！", imagePosition: "left", text: [
        "普段通っている建物の間や校舎の周りでも、地図を持つと見え方が変わります。",
        "階段、通路、広場、建物の通行可否を読みながら、短い距離で細かい判断を重ねます。"
      ] },
      { type: "image", src: IMG.forestCourse, alt: "赤と青のルート候補を描いたフォレストのコース例", caption: "赤と青のルート候補を比べてみましょう。" },
      { type: "h3", text: "実際にやってみよう" },
      { type: "p", text: "では、実際にオリエンテーリングをやってみましょう。" },
      { type: "p", html: "画像は、京都大学が保有している地図（<a href=\"equipment.html#maps\">備品→地図</a>）の一つを切り抜いたものです。紫の丸（ポスト）を移動する場合、表示されている赤のルートと青のルート、どちらが速いでしょうか。" },
      { type: "p", text: "一見、ほぼ最短距離でポストの間を走れそうですが、山の中を走ったり、等高線と呼ばれる茶色の線をたくさん跨がないといけません。一方で、青はどうでしょうか。一見遠回りのようですが、太い茶色で表記されている道を走れ、そのあともまたぐ等高線は最小限のため、快適に走ることができます。こうした、地図の情報を適切に読む力がオリエンテーリングでは重要になってきます。" },
      { type: "note", html: "多くの大会で、走った後の結果は<a href=\"https://mulka2.com/lapcenter/\">lapcenter</a>で確認できます。" }
    ] }]
  },
  ...
  appeal: {
    ...
    sections: [{ blocks: [
      ...
      { type: "h3", text: "頭と体を両方使う" },
      { type: "p", text: "オリエンテーリングでは、不整地を走る走力だけでなく地図から正確に情報を読み取る知力も求められます。「総合戦」としてのスポーツは、この競技の大きな魅力です。" },
  ...
  equipment: {
    ...
    sections: [
      ...
      { id: "maps", title: "地図販売", blocks: [
        { type: "h3", text: "販売地図の利用" },
        { type: "p", text: "京大OLCでは、作成したマップを大会用・練習会用に販売しています。初めて使う地図では、立入禁止や通行不可の表記を事前に確認してください。" },
        { type: "p", text: "地図の購入を希望する場合は、希望する地図名、枚数、使用日を伝えてください。テレインの渉外方法も地図販売時に案内します。" },
  ...
  history: {
    ...
    sections: [{ blocks: [
      ...
      { type: "p", text: "吉田山や東山など、京都周辺の地図の作成や大会運営を実施しています。様々な面からオリエンテーリング競技の振興を図っています。" }
    ] }]
  },
